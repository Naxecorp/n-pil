...
MachineObjectModel machineObjectModelFromJson(String str) =>
    MachineObjectModel.fromJson(json.decode(str));
...
class MachineObjectModel {
  ...
  factory MachineObjectModel.fromJson(Map<String, dynamic> json) =>
      MachineObjectModel(
        key: json["key"],
        flags: json["flags"],
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        fans: json["fans"] == null
            ? []
            : List<Fan?>.from(
                json["fans"]!.map((x) => x == null ? null : Fan.fromJson(x))),
        ...
        spindles: json["spindles"] == null
            ? []
            : List<Spindle>.from(
                json["spindles"]!.map((x) => Spindle.fromJson(x))),
        state:
            json["state"] == null ? null : StateClass.fromJson(json["state"]),
...
class Heat {
  ...
  factory Heat.fromJson(Map<String, dynamic> json) => Heat(
        heaters: json["heaters"] == null
            ? []
            : List<Heater>.from(
                json["heaters"]!.map((x) => Heater.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "heaters": heaters == null
            ? []
            : List<dynamic>.from(heaters!.map((x) => x.toJson())),
      };
}
...
class Move {
  ...
  factory Move.fromJson(Map<String, dynamic> json) => Move(
        axes: json["axes"] == null
            ? []
            : List<Axe>.from(json["axes"]!.map((x) => Axe.fromJson(x))),
        currentMove: json["currentMove"] == null
            ? null
            : CurrentMove.fromJson(json["currentMove"]),
        extruders: json["extruders"] == null
            ? []
            : List<Extruder>.from(
                json["extruders"]!.map((x) => Extruder.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        "axes": axes == null
            ? []
            : List<dynamic>.from(axes!.map((x) => x.toJson())),
        "currentMove": currentMove?.toJson(),
        "extruders": extruders == null
            ? []
            : List<dynamic>.from(extruders!.map((x) => x.toJson())),
...
class Sensors {
  ...
  factory Sensors.fromJson(Map<String, dynamic> json) => Sensors(
        ...
        gpIn: json["gpIn"] == null
            ? []
            : List<GpIn?>.from(
                json["gpIn"]!.map((x) => x == null ? null : GpIn.fromMap(x))),
        probes: json["probes"] == null
            ? []
            : List<Probe>.from(json["probes"]!.map((x) => Probe.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "analog": analog == null
            ? []
            : List<dynamic>.from(analog!.map((x) => x.toJson())),
        "endstops": endstops == null
            ? []
            : List<dynamic>.from(endstops!.map((x) => x.toJson())),
        "filamentMonitors": filamentMonitors == null
            ? []
            : List<dynamic>.from(filamentMonitors!.map((x) => x)),
        "gpIn": gpIn == null
            ? []
            : List<dynamic>.from(gpIn!.map((x) => x?.toMap())),
        "probes": probes == null
            ? []
            : List<dynamic>.from(probes!.map((x) => x.toJson())),
      };
}
...
class GpIn {
  ...
  factory GpIn.fromJson(String str) => GpIn.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GpIn.fromMap(Map<String, dynamic> json) => GpIn(
        value: json["value"],
      );
...
class Probe {
  ...
  factory Probe.fromJson(Map<String, dynamic> json) => Probe(
        value: json["value"] == null
            ? []
            : List<num>.from(json["value"]!.map((x) => x)),
      );
...
class Seqs {
  ...
  factory Seqs.fromJson(Map<String, dynamic> json) => Seqs(
        ...
        state: json["state"],
        tools: json["tools"],
        volChanges: json["volChanges"] == null
            ? []
            : List<num>.from(json["volChanges"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "state": state,
        "tools": tools,
        "volChanges": volChanges == null
            ? []
            : List<dynamic>.from(volChanges!.map((x) => x)),
        "volumes": volumes,
      };
}
...
class Tool {
  ...
  factory Tool.fromJson(Map<String, dynamic> json) => Tool(
        ...
        standby: json["standby"] == null
            ? []
            : List<dynamic>.from(json["standby"]!.map((x) => x)),
        state: json["state"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "standby":
            standby == null ? [] : List<dynamic>.from(standby!.map((x) => x)),
        "state": state,
      };
}
