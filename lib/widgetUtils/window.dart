  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ConstrainedBox(
            constraints: const BoxConstraints(minHeight: 1,maxHeight: 40),
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ConstrainedBox(
                    constraints: BoxConstraints(maxHeight: 40,minHeight: 15,maxWidth: 1000),
                    child: Text(
                      widget.title1,
                      style: TextStyle(color: Color(0xFF707585),fontWeight: FontWeight.bold,fontSize: 20),
                      textAlign: TextAlign.start,
                    ),
                  ),
                  ConstrainedBox(
                    constraints: BoxConstraints(maxHeight: 40,minHeight: 15,),
                    child: Text(
                    widget.title2,
                    style: TextStyle(color: Color(0xFF707585),fontWeight: FontWeight.w100,fontSize: 20),
                      textAlign: TextAlign.start,
                  ),
                  ),
                ],
