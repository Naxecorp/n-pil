...
class Joystick2 extends StatefulWidget {
  ...
  @override
  _JoystickState2 createState() => _JoystickState2(
      onUpPressed,
      onDownPressed,
      onRotateARPressed,
      onRotateALPressed,
...
class _JoystickState2 extends State<Joystick2> {
  ...
  _JoystickState2(this.onUpPressed, this.onDownPressed, this.onRotateARPressed,
      this.onRotateALPressed, this.onRotateCRPressed, this.onRotateCLPressed);
